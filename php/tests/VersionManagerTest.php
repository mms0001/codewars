...
class VersionManagerTest extends TestCase {
    ...
    public function testRollbacks() {
      try {
        ...
        $this->assertSame("17.0.1", (new VersionManager("14.53.29.d.30"))->minor()->major()->major()->rollback()->patch()->major()->major()->patch()->rollback()->patch()->release());
    ...
    public function testSeperatedCalls() {
      try {
